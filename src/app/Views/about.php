...
<p>For test and evaluation. <?php echo $content ?></p>

<h4 >NBN attribution information</h4> 
<div id="attribution"> 
  ...
  <p> You may satisfy the conditions in <a href="https://creativecommons.org/licenses/by/4.0/legalcode#s3a1" target="_blank">Section 3(a)(1)</a> in any reasonable manner based on the medium, means, and context in which You Share the Licensed Material. For example, it may be reasonable to satisfy the conditions by providing a URI or hyperlink to a resource that includes the required information.</p> 
  <p> If requested by the Licensor, You must remove any of the information required by <a href="https://creativecommons.org/licenses/by/4.0/legalcode#s3a1A" target="_blank">Section 3(a)(1)(A)</a> to the extent reasonably practicable.</p> 
