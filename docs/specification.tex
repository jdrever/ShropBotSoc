...
\begin{todolist}
  ...
  \item The download link, downloads a zipped CSV of the search results directly from the NBN.
  \item Site link goes to what? % // TODO: Ask John, all for site or just that species
  \item Square link goes where? % // TODO: Ask John, all for square or just that species
\end{todolist}
...
\begin{todolist}
  \item Zoomable slippy map.
  \item The location of the record is marked with a blob?  % // TODO: Ask John, could be a square?
  \item For mobiles the map is more compact.
\end{todolist}
...
\begin{itemize}
  ...
  \item Search results from the `location\_id'.
