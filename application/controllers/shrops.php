...
class Shrops extends CI_Controller {
	...
	public function index()
            ...
            else
	    {
                ...
                $axio = '0';
                if ($this->input->post('axiosonly') == 'ischecked') $axio = '1';
                ...
                //The value of $axio has to be a string since sspAxio is type 'enum'
                    ...
                    else  if  ($this->input->post('speciesname')  !== '')
      ...
      public function sites()
            ...
            else
	    {
                ...
                else 
                {
                    ...
                    else  if  ($this->input->post('sitename')  !== '')
            ...
            else
	    {
                    ...
                    else  if  ($this->input->post('tetradname')  !== '')
