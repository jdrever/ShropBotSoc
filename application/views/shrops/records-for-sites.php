...
//Displays a summary table of records for an individual site
...
echo '<h2>Displaying records for '. $sites['siteName'] . ' - '.$total_rows. ' total</h2>';
 
echo "<div class='center' id ='pagination'>" . $links . "</div>";
$this->table->set_template($tmpl);
$this->table->set_heading('','Latin Name','Common Name','Group','Grid Ref','Recorder(s)','Year');
